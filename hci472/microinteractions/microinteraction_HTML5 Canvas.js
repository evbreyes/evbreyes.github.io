...
lib.ssMetadata = [
		{name:"microinteraction_HTML5 Canvas_atlas_1", frames: [[0,0,862,1754]]}
];
...
(lib.chromesearch___localntp_localntphtmliPhone6_7_81 = function() {
	this.initialize(ss["microinteraction_HTML5 Canvas_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.microinteraction_HTML5Canvas = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({regY:0.1,scaleY:0.9997,y:464.95},0).to({regY:0,scaleX:1.2857,scaleY:0.7143,x:399.95,y:470.3},3,cjs.Ease.quadIn).to({scaleX:0.8571,scaleY:1.1428,x:400,y:410},7,cjs.Ease.quadOut).to({scaleX:1.2857,scaleY:0.7143,x:399.95,y:470.3},7,cjs.Ease.sineIn).to({scaleX:1,scaleY:1,x:400,y:465},4,cjs.Ease.quadIn).wait(2));
...
// library properties:
lib.properties = {
	id: '04550127D9B0774CB4456E690DB481EE',
	width: 800,
	height: 600,
	fps: 24,
	color: "#E2AB84",
	opacity: 1.00,
	manifest: [
		{src:"images/microinteraction_HTML5 Canvas_atlas_1.png", id:"microinteraction_HTML5 Canvas_atlas_1"}
	],
	preloads: []
};
...
an.compositions['04550127D9B0774CB4456E690DB481EE'] = {
